...
using MovieTutorial.Web.Administration;
using MovieTutorial.Web.Administration.Entities;
using MovieTutorial.Web.Administration.Repositories;
using MovieTutorial.Web.Common;
using Serenity;
using Serenity.Data;
...
namespace MovieTutorial.Web.Membership.Pages
{
